...
import clr
clr.AddReferenceToFileAndPath(Path.GetFullPath(r"..\..\..\..\lib\HtmlAgilityPack.1.4.0.beta2.binaries\HtmlAgilityPack.dll"))
...
speakerNodes = html.DocumentNode.SelectNodes("//div[@class='Speaker']")
	...
	def __str__(self): return "Speaker '%s'" % self.name
